...
const DEFAULT_WHEEL_SLOTS: WheelSlot[] = [
  { index: 0, label: "1.5K", sublabel: "Liquid", color: "#FFD700", amount: "1.5K VICT", rawAmount: 1500, type: "liquid_victory", valueUSD: 0, lockType: "LIQUID", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 1, label: "2.5K", sublabel: "Liquid", color: "#FFA500", amount: "2.5K VICT", rawAmount: 2500, type: "liquid_victory", valueUSD: 0, lockType: "LIQUID", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 2, label: "30K", sublabel: "Liquid", color: "#FF8C00", amount: "30K VICT", rawAmount: 30000, type: "liquid_victory", valueUSD: 0, lockType: "LIQUID", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 3, label: "5K", sublabel: "1W Lock", color: "#4FC3F7", amount: "5K VICT", rawAmount: 5000, type: "locked_victory", valueUSD: 0, lockType: "1W LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 4, label: "9K", sublabel: "1W Lock", color: "#29B6F6", amount: "9K VICT", rawAmount: 9000, type: "locked_victory", valueUSD: 0, lockType: "1W LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 5, label: "5K", sublabel: "3M Lock", color: "#03A9F4", amount: "5K VICT", rawAmount: 5000, type: "locked_victory", valueUSD: 0, lockType: "3M LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 6, label: "30K", sublabel: "3M Lock", color: "#039BE5", amount: "30K VICT", rawAmount: 30000, type: "locked_victory", valueUSD: 0, lockType: "3M LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 7, label: "30K", sublabel: "1Y Lock", color: "#0288D1", amount: "30K VICT", rawAmount: 30000, type: "locked_victory", valueUSD: 0, lockType: "1Y LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 8, label: "300K", sublabel: "1Y Lock", color: "#0277BD", amount: "300K VICT", rawAmount: 300000, type: "locked_victory", valueUSD: 0, lockType: "1Y LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 9, label: "40K", sublabel: "3Y Lock", color: "#7B1FA2", amount: "40K VICT", rawAmount: 40000, type: "locked_victory", valueUSD: 0, lockType: "3Y LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 10, label: "300K", sublabel: "3Y Lock", color: "#8E24AA", amount: "300K VICT", rawAmount: 300000, type: "locked_victory", valueUSD: 0, lockType: "3Y LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 11, label: "1.5M", sublabel: "3Y Lock", color: "#9C27B0", amount: "1.5M VICT", rawAmount: 1500000, type: "locked_victory", valueUSD: 0, lockType: "3Y LOCK", tokenSymbol: "VICT", tokenPrice: 0, tokenChange24h: 0 },
  { index: 12, label: "200K", sublabel: "SuiTrump", color: "#EF5350", amount: "200K SUITRUMP", rawAmount: 200000, type: "suitrump", valueUSD: 0, lockType: "MEME", tokenSymbol: "SUITRUMP", tokenPrice: 0, tokenChange24h: 0 },
  { index: 13, label: "500K", sublabel: "SuiTrump", color: "#F44336", amount: "500K SUITRUMP", rawAmount: 500000, type: "suitrump", valueUSD: 0, lockType: "MEME", tokenSymbol: "SUITRUMP", tokenPrice: 0, tokenChange24h: 0 },
  { index: 14, label: "10M", sublabel: "SuiTrump", color: "#E53935", amount: "10M SUITRUMP", rawAmount: 10000000, type: "suitrump", valueUSD: 0, lockType: "MEME", tokenSymbol: "SUITRUMP", tokenPrice: 0, tokenChange24h: 0 },
        ...
        {activeTab === 'prizes' && (
          <div>
            ...
            <div className="flex flex-wrap gap-3 justify-center pt-3 mt-3 border-t border-border">
              ...
              <div className="flex items-center gap-1 text-[10px]"><TrendingUp className="w-3 h-3 text-red-400" /><span className="text-text-muted">SuiTrump</span></div>
            </div>
          </div>
        )}
      </div>
