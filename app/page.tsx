      ...
      <main className="flex-1">
        ...
        <section className="relative py-12 sm:py-16 lg:py-20 px-4 overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] lg:w-[900px] lg:h-[900px] rounded-full bg-accent/8 blur-[120px]" />
            <div className="absolute top-1/3 left-1/4 w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] rounded-full bg-green-500/6 blur-[100px]" />
            <div className="absolute bottom-1/4 right-1/4 w-[250px] h-[250px] sm:w-[350px] sm:h-[350px] rounded-full bg-purple-500/5 blur-[100px]" />
          </div>
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="text-center mb-8 sm:mb-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 mb-4">
                ...
                <span className="text-xs font-semibold text-green-400 uppercase tracking-wider">Live Rewards</span>
              </div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3">
                Earn <span className="bg-gradient-to-r from-accent via-green-400 to-accent bg-clip-text text-transparent">Free Spins</span>
              </h2>
              <p className="text-text-secondary text-sm sm:text-base max-w-lg mx-auto">
                Get <span className="text-accent font-semibold">1 free spin</span> for every <span className="text-white font-semibold">$20</span> in LP staked or swapped on SuiDex
              </p>
            </div>

            {/* Main Card */}
            <div className="rounded-2xl border border-border/50 bg-[#0a0c10]/80 backdrop-blur-xl overflow-hidden shadow-2xl shadow-accent/5">
              {/* LP Pools */}
              <div className="p-5 sm:p-6 lg:p-8">
                <div className="flex items-center gap-2 mb-4">
                  <div className="flex items-center justify-center w-7 h-7 rounded-lg bg-green-500/10 border border-green-500/20">
                    <Lock className="w-3.5 h-3.5 text-green-400" />
                  </div>
                  <span className="text-sm font-bold text-white">Stake LP</span>
                  <div className="flex-1 h-px bg-gradient-to-r from-green-500/20 to-transparent" />
                  <span className="text-[10px] text-text-muted hidden sm:block">Earn spins while staked</span>
                </div>
                  ...
                  {LP_POOLS.filter(p => p.enabled).map((pool) => {
                    ...
                    return (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group relative flex items-center gap-3 p-4 rounded-xl border border-border/50 bg-gradient-to-br from-white/[0.03] to-transparent hover:border-green-500/40 hover:bg-green-500/5 hover:shadow-lg hover:shadow-green-500/5 transition-all duration-300"
                      >
                        {/* Hover glow */}
                        <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-green-500/0 to-green-500/0 group-hover:from-green-500/5 group-hover:to-transparent transition-all duration-300" />
                        <div className="relative flex -space-x-2 flex-shrink-0">
                          <img src={token0.logo} alt={token0.symbol} className="w-10 h-10 rounded-full border-2 border-[#0a0c10] bg-[#0a0c10] group-hover:border-green-500/20 transition-colors" />
                          <img src={token1.logo} alt={token1.symbol} className="w-10 h-10 rounded-full border-2 border-[#0a0c10] bg-[#0a0c10] group-hover:border-green-500/20 transition-colors" />
                        </div>
                        <div className="relative flex-1 min-w-0">
                          <div className="text-sm font-bold text-white">{pool.label}</div>
                          <div className="text-[11px] text-text-muted">farm.suidex.org</div>
                        </div>
                        <div className="relative flex items-center gap-1.5 text-xs font-semibold text-green-400 opacity-50 group-hover:opacity-100 transition-all">
              ...
              <div className="p-5 sm:p-6 lg:p-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-bold text-white">Swap</span>
                  <div className="flex-1 h-px bg-gradient-to-r from-yellow-500/20 to-transparent" />
                  <span className="text-[10px] text-text-muted hidden sm:block">Earn spins per swap</span>
                </div>
                  ...
                  {SWAP_PAIRS.filter(p => p.enabled).map((pair) => {
                    ...
                    return (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="group flex items-center gap-3 p-3.5 rounded-xl border border-border/40 bg-gradient-to-br from-white/[0.02] to-transparent hover:border-yellow-500/30 hover:bg-yellow-500/5 hover:shadow-lg hover:shadow-yellow-500/5 transition-all duration-300"
                      >
                        <div className="flex -space-x-1.5 flex-shrink-0">
                          <img src={token0.logo} alt={token0.symbol} className="w-7 h-7 rounded-full border border-[#0a0c10] bg-[#0a0c10] group-hover:border-yellow-500/20 transition-colors" />
                          <img src={token1.logo} alt={token1.symbol} className="w-7 h-7 rounded-full border border-[#0a0c10] bg-[#0a0c10] group-hover:border-yellow-500/20 transition-colors" />
                        </div>
                        <span className="text-sm font-medium text-text-secondary group-hover:text-white transition-colors">{pair.label}</span>
                        <ArrowRight className="w-3.5 h-3.5 text-yellow-400/40 group-hover:text-yellow-400 group-hover:translate-x-0.5 transition-all ml-auto" />
                      </a>
                    )
                  })}
                </div>
              ...
              <div className="px-5 sm:px-6 lg:px-8 pb-5 sm:pb-6 lg:pb-8">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-4 rounded-xl bg-gradient-to-r from-accent/5 via-accent/10 to-accent/5 border border-accent/10">
                  <div className="flex items-center gap-3 text-center sm:text-left">
                    <div className="hidden sm:flex items-center justify-center w-10 h-10 rounded-full bg-accent/10 border border-accent/20">
                      <Sparkles className="w-5 h-5 text-accent" />
                    </div>
                    <div>
                      <div className="text-sm font-semibold text-white">Start earning free spins today</div>
                      <div className="text-[11px] text-text-muted">Stake LP or swap tokens on SuiDex DEX</div>
                    </div>
                  </div>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold bg-accent text-black hover:bg-accent-hover transition-colors whitespace-nowrap"
                  >
                    Open SuiDex
