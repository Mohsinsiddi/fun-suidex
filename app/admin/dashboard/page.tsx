    ...
    <div className="min-h-screen flex bg-background">
      ...
      <aside className="w-64 admin-sidebar flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <Link href="/admin/revenue" className="admin-nav-item">
            <DollarSign className="w-5 h-5" />
            Revenue
          </Link>
          <Link href="/admin/distribute" className="admin-nav-item">
          ...
          <Link href="/admin/config" className="admin-nav-item">
      ...
      <main className="flex-1 p-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <StatCard
              title="Revenue (SUI)"
              value={stats?.totalRevenueSUI?.toFixed(2) ?? '-'}
              icon={TrendingUp}
              loading={loading}
              accent
            />
            <StatCard
              ...
              icon={Gift}
              loading={loading}
              warning={stats?.pendingPrizes ? stats.pendingPrizes > 0 : false}
            />
          </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-accent">
                    {stats?.todayRevenueSUI?.toFixed(2) ?? '-'} SUI
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="card p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Link
                href="/admin/revenue"
                className="p-4 bg-background rounded-lg text-center hover:bg-card-hover transition-colors"
              >
