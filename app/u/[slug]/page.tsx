        ...
        <div className="max-w-4xl mx-auto">
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-accent text-black font-medium hover:bg-accent-hover transition-colors"
              >
                Go Home
              </Link>
            </div>
            ...
            <>
              ...
              <div className="mt-8 text-center">
                ...
                <Link
                  href="/wheel"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-accent text-black font-medium hover:bg-accent-hover transition-colors"
                >
                  Start Playing
                </Link>
              </div>
